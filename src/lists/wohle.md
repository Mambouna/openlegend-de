...
**Beschreibung**  
Du verleihst dir oder einem Verbündeten die Fähigkeit, das wahrzunehmen, was nicht mit normalen Sinnen erfasst werden kann. Hindernisse, die normale Sicht aufhalten würden - Dunkelheit, feste Gegenstände, Illusionen und sogar Grenzen zwischen den Realitätsebenen - werden durchbrochen. Diese Kraft könnte von übernatürlichen Sinnen stammen, himmlischem Segen, cybernetisch verbesserten Sinnesorganen oder aus ähnlichen Quellen.

**Effekt**  
<ul>
  <li><strong>Kraftlevel 5</strong> - Das Ziel sieht die Präsenz außergewöhnlicher Effekte wie Magie, Stealth-Technologie und anderer Art, die außervisuell wahrgenommen werden können. Weiterhin gibt dieses Wohl Vorteil 1 auf Würfe, mit denen einfache Verborgenheit wie bei versteckten Durchgänge, doppelten Böden und Fallen oder anderen Gefahren durchschaut werden soll.</li>
  <li><strong>Kraftlevel 6</strong> - Die außergewöhnliche Sicht des Ziels durchdringt natürliche und magische Dunkelheit.</li>
  <li><strong>Kraftlevel 7</strong> - Die außergewöhnliche Sicht des Ziels durchdringt alle Arten illusorischer Effekte, sodass es auch <em>Phantome</em> durchschaut.</li>
  <li><strong>Kraftlevel 8</strong> - Das Ziel kann durch feste Materialien hindurchsehen und seine normale Sichtweite bleibt von ihnen unbehindert.</li>
  <li><strong>Kraftlevel 9</strong> - Die außergewöhnliche Sicht lässt das Ziel in andere Realitätsebenen oder Dimensionen blicken. Es kann in Taschendimensionen und andere Realitätsebenen sehen, die mit der momentanen überlappen. Weiterhin ist die Sichtweite des Ziels stark erweitert.</li>
</ul>
...
**Effekt**  
Du erschaffst oder beschwörst einen temporären NPC-Verbündeten, der sich unter deiner Kontrolle befindet, wobei dieser aber von begrenzter Intelligenz ist. Die Werte des NPCs werden durch das Kraftlevel dieses Wohls bestimmt. Du kannst die Attributwerte frei unter den folgen Attributen verteilen: Beweglichkeit, Konstitution, Kraft, Wahrnehmung, Energie, Vergehen. Die Attribute deines NPCs wirken sich nicht auf seine Trefferpunkte oder Verteidigungen aus.
